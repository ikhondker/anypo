...
<div class="dropdown me-2 d-inline-block position-relative">
	...
	<div class="dropdown-menu dropdown-menu-end">
		...
		<a class="dropdown-item" href="{{ route('tables.helpers') }}"><i class="align-middle me-1" data-feather="user"></i> Helpers</a>
		<div class="dropdown-divider"></div>
		...
		<a class="dropdown-item" href="{{ route('tables.fnc-policies') }}"><i class="align-middle me-1" data-feather="user"></i> Fnc Policies</a>
