			...
			<div class="card-body py-4">
				<div class="d-flex align-items-start">
					<div class="flex-grow-1">
						...
						<p class="mb-2">Approved Purchase Orders</p>
						<div class="mb-0">
			...
			<div class="card-body py-4">
				<div class="d-flex align-items-start">
					<div class="flex-grow-1">
						...
						<p class="mb-2">In-Process Purchase Orders</p>
						<div class="mb-0">
							<span class="badge badge-subtle-success me-2"> {{ $_setup->currency }} </span>
			...
			<div class="card-body py-4">
				<div class="d-flex align-items-start">
					<div class="flex-grow-1">
						...
						<p class="mb-2">Draft Purchase Orders</p>
						<div class="mb-0">
							{{-- <span class="badge badge-subtle-success me-2"> {{ $_setup->currency }} </span>
					...
					<div class="d-inline-block ms-3">
						<div class="stat">
							<i class="align-middle text-success" data-lucide="edit"></i>
						</div>
					</div>
				</div>
			</div>
