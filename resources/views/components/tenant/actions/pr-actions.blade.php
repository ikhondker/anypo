<div class="dropdown me-2 d-inline-block position-relative">
	...
	<div class="dropdown-menu dropdown-menu-end">
		...
		<a class="dropdown-item sweet-alert2-advance" href="{{ route('prs.copy', $id) }}"
		...
		<a class="dropdown-item sweet-alert2-advance" href="{{ route('prs.convert', $id) }}"
		...
		<a class="dropdown-item sweet-alert2-advance" href="{{ route('wfs.wf-reset-pr', $id) }}"
		...
		<a class="dropdown-item sweet-alert2-advance" href="{{ route('prs.cancel', $id) }}"
		...
		<a class="dropdown-item sweet-alert2-advance" href="{{ route('prs.destroy', $id) }}"
		...
		@if ( auth()->user()->role->value == UserRoleEnum::SYSTEM->value)
			<a class="dropdown-item sweet-alert2-advance" href="{{ route('prs.recalculate', $id) }}"
