<div class="dropdown me-2 d-inline-block position-relative">
	...
	<div class="dropdown-menu dropdown-menu-end">
		...
		<div class="dropdown-divider"></div>
		<a class="dropdown-item" href="{{ route('invoices.create', $po->id) }}"><i class="align-middle me-1" data-lucide="plus-circle"></i> Create Invoice</a>
		<a class="dropdown-item sw2-advance" href="{{ route('pos.copy', $po->id) }}"
			...
			<i class="align-middle me-1 text-primary" data-lucide="copy"></i> Copy Purchase Order</a>
