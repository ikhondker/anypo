<div class="dropdown me-2 d-inline-block position-relative">
	...
	<div class="dropdown-menu dropdown-menu-end">
		...
		@if (Route::current()->getName() == 'budgets.edit')
			<a class="dropdown-item" href="{{ route('budgets.show', $budgetId) }}"><i class="align-middle me-1" data-lucide="eye"></i> View Budget</a>
		@endif
		@if (Route::current()->getName() == 'budgets.show')
			<a class="dropdown-item" href="{{ route('budgets.edit', $budgetId) }}"><i class="align-middle me-1" data-lucide="edit"></i> Edit Budget</a>
		@endif

		<div class="dropdown-divider"></div>
		<a class="dropdown-item" href="{{ route('budgets.attachments',$budgetId) }}"><i class="align-middle me-1" data-lucide="paperclip"></i> View Attachments</a>
		<a class="dropdown-item" href="{{ route('budgets.revisions', $budgetId) }}"><i class="align-middle me-1" data-lucide="edit-3"></i> View Revisions (*)</a>

		<div class="dropdown-divider"></div>
		<a class="dropdown-item" href="{{ route('budgets.index') }}"><i class="align-middle me-1" data-lucide="list"></i> View All</a>

		<div class="dropdown-divider"></div>
		<a class="dropdown-item sw2-advance" href="{{ route('budgets.destroy',$budgetId) }}"
