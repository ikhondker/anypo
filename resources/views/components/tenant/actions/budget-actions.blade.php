<div class="dropdown me-2 d-inline-block position-relative">
	...
	<div class="dropdown-menu dropdown-menu-end">
		<a class="dropdown-item" href="{{ route('budgets.show', $id) }}"><i class="align-middle me-1" data-lucide="edit"></i> View Budget</a>
		...
		<a class="dropdown-item" href="{{ route('budgets.attachments',$id) }}"><i class="align-middle me-1" data-lucide="paperclip"></i> Attachments</a>
