<div class="dropdown me-2 d-inline-block position-relative">
	...
	<div class="dropdown-menu dropdown-menu-end">
		<a class="dropdown-item" href="{{ route('activities.all') }}"><i class="align-middle me-1" data-lucide="eye"></i> View All(*)</a>

		<div class="dropdown-divider"></div>
		<a class="dropdown-item" href="{{ route('activities.all', ['type'=>  App\Enum\Landlord\InvoiceTypeEnum::SUBSCRIPTION->value ]) }}"><i class="align-middle me-1" data-lucide="eye"></i> TO By Type(*)</a>
