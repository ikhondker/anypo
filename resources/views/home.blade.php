...
@section('content')
    ...
    <div class="container content-space-t-4 content-space-t-lg-5 content-space-b-2 content-space-b-lg-3">
        ...
        <div class="row justify-content-lg-between align-items-lg-center mb-10">
            <div class="col-md-6 col-lg-5">
              <!-- Heading -->
              <div class="mb-5">
                <h1>Build awesome apps with your web skills 2</h1>
            ...
            <div class="col-sm-7 col-md-6 d-none d-md-block">
              <img class="img-fluid" src="{{ asset('/assets/svg/illustrations/oc-relaxing.svg') }}" alt="Image Description">
            </div>
            <!-- End Col -->
        </div>
        <!-- End Row -->
    ...
    <div class="container content-space-2 content-space-lg-3">
      <div class="text-center mb-5">
        <img class="avatar avatar-lg avatar-4x3" src="./assets/svg/illustrations/oc-person-1.svg" alt="Illustration">
      </div>
