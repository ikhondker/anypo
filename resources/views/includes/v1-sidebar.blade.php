<ul class="sidebar-nav">
    ...
    <li class="sidebar-item {{ ($_route_name == 'notifications.index' ? "active" : "") }}">
        <a class="sidebar-link" href="{{ route('notifications.index') }}">
            ...
            <span class="badge badge-sidebar-primary">{{ $_count_notifications }}</span>
        </a>
    </li>
    <li class="sidebar-item {{ ($_route_name == 'prs.index' ? "active" : "") }}">
        <a class="sidebar-link" href="{{ route('prs.index') }}">
            <i class="align-middle" data-feather="layout"></i><span class="align-middle">PR *</span>
        </a>
    </li>
    <li class="sidebar-item {{ ($_route_name == 'pos.index' ? "active" : "") }}">
        <a class="sidebar-link" href="{{ route('pos.index') }}">
            <i class="align-middle" data-feather="layout"></i><span class="align-middle">PO *</span>
        </a>
    </li>
    <li class="sidebar-item {{ ($_route_name == 'receipts.index' ? "active" : "") }}">
        <a class="sidebar-link" href="{{ route('receipts.index') }}">
            <i class="align-middle" data-feather="layout"></i><span class="align-middle">Receipts *</span>
        </a>
    </li>
    <li class="sidebar-item {{ ($_route_name == 'payments.index' ? "active" : "") }}">
        <a class="sidebar-link" href="{{ route('payments.index') }}">
            <i class="align-middle" data-feather="layout"></i><span class="align-middle">Payments **</span>
        </a>
    </li>
    ...
    <li class="sidebar-item {{ ($_node_name == 'reports' ? "active" : "") }}">
        <a data-bs-target="#reports"s data-bs-toggle="collapse" class="sidebar-link collapsed">
            ...
            <span class="align-middle">Repors</span>
        </a>
    ...
    <li class="sidebar-item {{ ($_node_name == 'item' ? "active" : "") }}">
        <a data-bs-target="#item" data-bs-toggle="collapse" class="sidebar-link collapsed">
            <i class="align-middle" data-feather="grid"></i> 
            <span class="align-middle">Items</span>
        </a>
        <ul id="item" class="sidebar-dropdown list-unstyled collapse {{ ($_node_name == 'item' ? "show" : "") }}" data-bs-parent="#sidebar">
    ...
    <li class="sidebar-item {{ ($_node_name == 'cancel' ? "active" : "") }}">
        ...
        <ul id="cancel" class="sidebar-dropdown list-unstyled collapse {{ ($_node_name == 'cancel' ? "show" : "") }}" data-bs-parent="#sidebar">
            ...
            <li class="sidebar-item {{ ($_route_name == 'prs.index' ? "active" : "") }}"><a class="sidebar-link" href="{{ route('prs.index') }}"><i class="align-middle" data-feather="circle"></i>Delete PR Attachment*</a></li>
            <li class="sidebar-item {{ ($_route_name == 'prs.index' ? "active" : "") }}"><a class="sidebar-link" href="{{ route('prs.index') }}"><i class="align-middle" data-feather="circle"></i>Delete PO Attachment*</a></li>
        </ul>
    </li>
