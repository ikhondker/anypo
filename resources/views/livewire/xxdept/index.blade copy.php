        ...
        <div wire:ignore.self class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                        <p>Are you sure want to delete? message={{ $message }} id={{ $this->myid }} name={{ $this->name }}</p>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body m-3">
                <p class="mb-0">Are you sure want to delete? message={{ $message }} id={{ $this->myid }} name={{ $this->name }}</p>
              ...
              <div class="modal-footer">
                ...
                <button type="button" wire:click.prevent="do()" class="btn btn-danger close-modal" data-bs-dismiss="modal">Yes, Delete</button>
              </div>
            </div>
          </div>
        </div>
