            ...
            <div class="card flex-fill">
                <div class="card-body">
                    ...
                    @php
                        ...
                        try {
                            $budget= Budget::where('fy', '2024')->get()->firstOrFail();
                    ...
                    <div class="mb-0">
                        ...
                        <span class="text-muted"> total budget for FY2023. Utilized {{ $budget_po_issued }}</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xxl-3 d-flex">
            <div class="card flex-fill">
                <div class="card-body">
                    <div class="row">
                        <div class="col mt-0">
                            <h5 class="card-title">PO Issued USD (TBD)</h5>
                        </div>
                        <div class="col-auto">
                            <div class="stat stat-sm">
        ...
        <div class="col-md-6 col-xxl-3 d-flex">
            <div class="card flex-fill">
                <div class="card-body">
                    <div class="row">
                        <div class="col mt-0">
                            <h5 class="card-title">PR Approved (USD)</h5>
                        </div>
        ...
        <div class="col-md-6 col-xxl-3 d-flex">
            <div class="card flex-fill">
                <div class="card-body">
                    ...
                    <span class="h1 d-inline-block mt-1 mb-3">123</span>
                    <div class="mb-0">
                        <span class="badge badge-soft-success me-2"> 123 </span>
        ...
        <div class="col-md-6 col-xxl-3 d-flex">
            <div class="card flex-fill">
                <div class="card-body">
                    <div class="row">
                        <div class="col mt-0">
                            <h5 class="card-title">PR Approved</h5>
                        </div>
