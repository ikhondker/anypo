...
<html lang="en">
    ...
    <head>
        ...
        <meta name="email" content="khondker@gmail.com" />
        <meta name="website" content="https://hawarIT.com" />
        ...
        <link href="{{asset('/site/css/tiny-slider.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset('/site/css/materialdesignicons.min.css')}}" rel="stylesheet" type="text/css" />
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="list-inline-item mb-0"><a href="javascript:void(0)" class="text-muted fw-normal"><i data-feather="mail" class="fea icon-sm text-primary"></i> Login</a></li>
                                <li class="list-inline-item mb-0 ms-3"><a href="javascript:void(0)" class="text-muted fw-normal"><i data-feather="map-pin" class="fea icon-sm text-primary"></i> Register</a></li>
                            </ul>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            ...
            <div class="container">
                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu nav-right">
                        <li><a href="{{ route('startyhtm') }}" class="sub-menu-item">Home</a></li>
                        <li><a href="{{ route('anypo') }}" class="sub-menu-item">AnyPO</a></li>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-8 mt-4 mt-sm-0">
                            <div class="text-sm-end text-center">
                                <p class="mb-0 text-muted"><script>document.write(new Date().getFullYear())</script> © HawarIT Limited <i class="mdi mdi-heart text-danger"></i> by <a href="https://shreethemes.in/" target="_blank" class="text-reset">Shreethemes</a>.</p>
                            </div>
                        </div><!--end col-->
                    </div><!--end row-->
                </div><!--end container-->
