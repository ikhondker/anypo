						...
						<li class="nav-item" role="presentation">
							<a class="nav-link" href="#featuresTwo" id="featuresTwo-tab" data-bs-toggle="tab" data-bs-target="#featuresTwo" role="tab" aria-controls="featuresTwo" aria-selected="false" style="min-width: 20rem;">
								...
								<div class="d-flex align-items-center align-items-lg-start">
									...
									<div class="flex-grow-1 ms-3">
										<h4 class="mb-1">Project Budget Control</h4>
										<p class="text-body text-wrap mb-0">Set spending limits for yout project, track your progress effortlessly and analyze if you're at risk of going over budget.</p>
									</div>
								</div>
								<!-- End Media -->
							</a>
