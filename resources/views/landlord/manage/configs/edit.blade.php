...
<div class="card">
	<form action="{{ route('configs.update',$config->id) }}" method="POST" enctype="multipart/form-data">
		...
		<div class="card-header d-flex justify-content-between align-items-center border-bottom">
			<h5 class="card-header-title">config Edit</h5>
		...
		<div class="card-body">
			...
			<div class="row mb-4">
				...
				<div class="col-sm-9">
					<div class="row">
						<x-landlord.edit.city value="{{ $config->city }}" />
						<x-landlord.edit.state value="{{ $config->state }}" />
						<x-landlord.edit.zip value="{{ $config->zip }}" />
					</div>
				</div>
			</div>
			<!-- End Form -->
