...
@section('content')
	<div class="d-grid gap-1 gap-lg-1">
		<div class="row">
			<x-landlord.widgets.kpi value="{{ $count_tickets }}" route="tickets"label="ALL TICKETS1" icon="com013"/>
			...
			<x-landlord.widgets.kpi value="{{ $count_all_closed_tickets }}" route="services" label="TOTAL CLOSED" icon="com006"/>
		</div>
		<!-- End Row -->
	</div>
