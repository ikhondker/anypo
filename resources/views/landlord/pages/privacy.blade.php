			...
			<div class="col-md-4 col-lg-3 mb-3 mb-md-0">
					<div class="card">
						...
						<div class="list-group list-group-flush" role="tablist">
							...
							<a class="list-group-item list-group-item-action" href="#intro" role="tab">1. Introduction</a>
							<a class="list-group-item list-group-item-action" href="#service" role="tab">2. Using our services</a>
							<a class="list-group-item list-group-item-action" href="#copyright" role="tab">3. Privacy and copyright protection</a>
							<a class="list-group-item list-group-item-action" href="#contents">4. Your content in our services</a>
						</div>
					</div>
			...
			<div class="col-md-8 col-lg-9">
				...
				<div class="card card-lg">
					...
					<div class="card-header bg-dark p-4 py-sm-10">
						...
						<p class="card-text text-white">Last modified: March 27, 2018</p>
					</div>
					<!-- End Header -->
