		...
		<div class="col-12">
			...
			<div class="card">
				<div class="card-header">
					...
					<h6 class="card-subtitle text-muted">List Suppliers and their contact person.</h6>
				</div>
				<div class="card-body">
					<table class="table">
						<thead>
						...
						<tbody>
							...
							<tr>
								...
								<td class="table-action">
									...
									<a href="{{ route('suppliers.destroy',$supplier->id) }}" class="me-2 sweet-alert2-advance"
