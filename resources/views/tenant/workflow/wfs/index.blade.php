		...
		@endslot
			...
			<div class="card">
				<div class="card-header">
					<x-tenant.card.header-search-export-bar model="Wf"/>
					<h5 class="card-title">
						@if (request('term'))
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td><x-tenant.list.my-badge :value="$wf->wf_status->value"/></td>
								<td><x-tenant.list.my-badge :value="$wf->auth_status->value"/></td>
