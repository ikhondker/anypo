...
@section('content')
	...
	<x-tenant.page-header>
		...
		@endslot
		@slot('buttons')
			<a href="{{ route('receipts.create-for-pol') }}" class="btn btn-primary float-end me-2"><i data-lucide="plus-circle"></i> Create</a>
		...
		<div class="col-12">
			...
			<div class="card">
				<div class="card-header">
					<x-tenant.card.header-search-bar object="Receipt"/>
					<h5 class="card-title">
						@if (request('term'))
