		...
		@slot('buttons')
			...
			<div class="dropdown me-2 d-inline-block position-relative">
				...
				<div class="dropdown-menu dropdown-menu-end">
					...
					<a class="dropdown-item sweet-alert2-advance"  href="{{ route('invoices.post', $invoice->id) }}"
					...
					<a class="dropdown-item sweet-alert2-advance"  href="{{ route('invoices.cancel', $invoice->id) }}"
