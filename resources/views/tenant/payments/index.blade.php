...
@section('content')
	...
	<x-tenant.page-header>
		...
		@endslot
		@slot('buttons')
			<a href="{{ route('payments.create-for-invoice') }}" class="btn btn-primary me-2"><i data-lucide="plus"></i> Create</a>
		...
		<div class="col-12">
			...
			<div class="card">
				<div class="card-header">
					 <x-tenant.card.header-search-export-xls entity="Payment"/>
					<h5 class="card-title">
						@if (request('term'))
