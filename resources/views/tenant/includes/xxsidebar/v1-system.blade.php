<ul class="sidebar-nav">
	...
	@can('viewBudgetMenu', App\Models\Tenant\Manage\Menu::class)
		<li class="sidebar-item {{ ($_node_name == 'budget' ? 'active' : '') }}">
			...
			<ul id="budget" class="sidebar-dropdown list-unstyled collapse {{ ($_node_name == 'budget' ? 'show' : '') }}" data-bs-parent="#sidebar">
				...
				<li class="sidebar-item {{ ($_route_name == 'projects.index' ? 'active' : '') }}"><a class="sidebar-link" href="{{ route('projects.index') }}"><i class="align-middle" data-feather="layout"></i>Project Budget</a></li>
	...
	@can('viewItemMenu', App\Models\Tenant\Manage\Menu::class)
