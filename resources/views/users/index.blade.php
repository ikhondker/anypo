        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <x-cards.header-search-export-bar object="User"/>
                    <h5 class="card-title">
                        @if (request('term'))
                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <x-list.my-avatar :avatar="$user->avatar"/>
                                ...
                                <td>{{ $user->cell }}</td>
                                <td><x-list.my-date-time :value="$user->last_login_at"/></td>
                                <td><x-list.my-badge :value="$user->role"/></td>
                                <td><x-list.my-boolean :value="$user->enable"/></td>
                                <td class="table-action">
                                    <x-list.actions object="User" :id="$user->id"/>
