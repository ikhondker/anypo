...
@section('content')
	...
	<a href="{{ route('domains.index') }}" class="btn btn-primary float-end mt-n1"><i data-lucide="database"></i> View all</a>
	<h1 class="h3 mb-3">View Domain</h1>

			<div class="card">
				<div class="card-header">
					<div class="card-actions float-end">
						<a href="{{ route('domains.index') }}" class="btn btn-sm btn-light"><i data-lucide="edit"></i> View all</a>
						@if (auth()->user()->isSystem())
							<a class="btn btn-sm btn-danger text-white" href="{{ route('domains.edit', $domain->id) }}"><i data-lucide="edit"></i> Edit</a>
						@endif
					</div>
