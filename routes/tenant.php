...
Route::middleware([
	...
	*/
	...
	Route::get('/wf/get-reset-po-num',[WfController::class,'getResetPrNum'])->name('wfs.get-reset-po-num');
	Route::post('/wf/wf-reset-po',[WfController::class,'wfResetPr'])->name('wfs.wf-reset-po');
