...
class WarehouseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('warehouses.index', compact('warehouses'))->with('i', (request()->input('page', 1) - 1) * 10);
    }
    ...
    public function create()
    {
        ...
        return view('warehouses.create', compact('countries'));
    }
    ...
    public function edit(Warehouse $warehouse)
    {
        ...
        $countries = Country::getAll();
        return view('warehouses.edit', compact('warehouse', 'countries'));
    }
