...
class TableController extends Controller
{
    ...
    public function index()
    {
        ...
        // }
        //dd($tables);
        return view('tables.index', compact('tables'))->with('i', 0);
    ...
    public function show(Table $table)
    {
        ...
        return view('tables.show', with(compact('table', 'columns')));
    }
    ...
    public function structure($table)
    {
        ...
        //dd($tname);
        $columns = DB::SELECT('describe '.$table);
        return view('tables.structure', with(compact('columns', 'table')));
    }
    ...
    public function controllers()
    {
        ...
        return view('tables.controllers', compact('filesInFolder'))->with('i', 0);
    ...
    public function models()
    {
        ...
        return view('tables.models', compact('filesInFolder'))->with('i', 0);
    ...
    public function routes()
    {
        ...
        return view('tables.all-routes', compact('routes'))->with('i', 0);
    }
    ...
    public function routeCode()
    {
        ...
        return view('tables.routes', compact('filesInFolder'))->with('i', 0);
    ...
    public function policies()
    {
        ...
        return view('tables.policies', compact('filesInFolder'))->with('i', 0);
    ...
    public function comments()
    {
        ...
        return view('tables.comments', compact('filesInFolder'))->with('i', 0);
