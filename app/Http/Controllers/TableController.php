...
class TableController extends Controller
{
	...
	public function index()
	{
		...
		// }
		//dd($tables);
		return view('tenant.backend.tables.index', compact('tables'))->with('i', 0);
	...
	public function show(Table $table)
	{
		...
		return view('tenant.backend.tables.show', with(compact('table', 'columns')));
	}
	...
	public function structure($table)
	{
		...
		//dd($tname);
		$columns = DB::SELECT('describe '.$table);
		return view('tenant.backend.tables.structure', with(compact('columns', 'table')));
	}
	...
	public function controllers()
	{
		...
		return view('tenant.backend.tables.controllers', compact('filesInFolder'))->with('i', 0);
	...
	public function models()
	{
		...
		return view('tenant.backend.tables.models', compact('filesInFolder'))->with('i', 0);
	...
	public function routes()
	{
		...
		return view('tenant.backend.tables.all-routes', compact('routes'))->with('i', 0);
	}
	...
	public function routeCode()
	{
		...
		return view('tenant.backend.tables.routes', compact('filesInFolder'))->with('i', 0);
	...
	public function policies()
	{
		...
		return view('tenant.backend.tables.policies', compact('filesInFolder'))->with('i', 0);
	...
	public function comments()
	{
		...
		return view('tenant.backend.tables.comments', compact('filesInFolder'))->with('i', 0);
