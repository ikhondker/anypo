 ...
 * @brief       This file contains the implementation of the InvoiceController class.
...
use App\Http\Requests\Landlord\StoreInvoiceRequest;
use App\Http\Requests\Landlord\UpdateInvoiceRequest;
...
class InvoiceController extends Controller
{
	...
	public function index()
	{
		...
		$invoices = Invoice::byAccount()->orderBy('id', 'DESC')->paginate(10);
		return view('landlord.invoices.index', compact('invoices'))->with('i', (request()->input('page', 1) - 1) * 10);
	}
	...
	public function create()
	{
		...
		return view('landlord.invoices.create', compact('account', 'setup'));
