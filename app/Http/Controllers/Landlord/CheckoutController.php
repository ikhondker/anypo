 ...
 * @brief       This file contains the implementation of the CheckoutController class.
...
use App\Http\Requests\Landlord\StoreCheckoutRequest;
use App\Http\Requests\Landlord\UpdateCheckoutRequest;
...
class CheckoutController extends Controller
{
	...
	public function all()
	{
		...
		return view('landlord.admin.checkouts.all', compact('checkouts'))->with('i', (request()->input('page', 1) - 1) * 10);
	}
	...
	public function show(Checkout $checkout)
	{
		...
		return view('landlord.checkouts.show', compact('checkout', 'entity'));
	}
