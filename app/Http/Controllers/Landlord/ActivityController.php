 ...
 * @brief       This file contains the implementation of the ActivityController class.
...
use App\Http\Requests\Landlord\StoreActivityRequest;
use App\Http\Requests\Landlord\UpdateActivityRequest;
...
class ActivityController extends Controller
{
	...
	public function index()
	{
		...
		return view('landlord.activities.index', compact('activities'))->with('i', (request()->input('page', 1) - 1) * 10);
	}
	...
	public function show(Activity $activity)
	{
		...
		return view('landlord.activities.show', compact('activity'));
	}
