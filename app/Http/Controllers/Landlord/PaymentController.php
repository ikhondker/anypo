...
use App\Http\Requests\Landlord\UpdatePaymentRequest;
...
class PaymentController extends Controller
{
	...
	public function index()
	{
		...
		return view('landlord.payments.index', compact('payments'))->with('i', (request()->input('page', 1) - 1) * 10);
	}
	...
	public function show(Payment $payment)
	{
		...
		return view('landlord.payments.show', compact('payment', 'entity'));
	}
