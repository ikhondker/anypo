 ...
 * @brief       This file contains the implementation of the AttachmentController class.
...
class AttachmentController extends Controller
{
	...
	public function index()
	{
		...
		return view('landlord.admin.attachments.index',compact('attachments'))->with('i', (request()->input('page', 1) - 1) * 10);
	}
