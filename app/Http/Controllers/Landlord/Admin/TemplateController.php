...
use App\Http\Requests\Landlord\Admin\StoreTemplateRequest;
use App\Http\Requests\Landlord\Admin\UpdateTemplateRequest;
...
class TemplateController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('landlord.admin.templates.index', compact('templates'))->with('i', (request()->input('page', 1) - 1) * 20);
    }
    ...
    public function create()
    {
        ...
        return view('landlord.admin.templates.create', compact('users', 'countries'));
    }
    ...
    public function show(Template $template)
    {
        ...
        $entity = 'TEMPLATE';
        return view('landlord.admin.templates.show', compact('template', 'entity'));
    }
    ...
    public function edit(Template $template)
    {
        ...
        return view('landlord.admin.templates.edit', compact('template', 'users', 'countries'));
    }
    ...
    public function submit(Template $template)
    {
        ...
        return redirect()->route('landlord.admin.templates.show', $template->id)->with('success', 'Template Submitted successfully');
    }
