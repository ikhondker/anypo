...
use App\Http\Requests\Landlord\Admin\StoreCountryRequest;
use App\Http\Requests\Landlord\Admin\UpdateCountryRequest;
...
class CountryController extends Controller
{
    ...
    public function index()
    {
		 ...
		 return view('landlord.admin.countries.index', compact('countries'))->with('i', (request()->input('page', 1) - 1) * 40);
    }
