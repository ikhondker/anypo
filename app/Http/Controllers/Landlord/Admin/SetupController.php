...
use App\Http\Requests\Landlord\Admin\StoreSetupRequest;
use App\Http\Requests\Landlord\Admin\UpdateSetupRequest;
...
class SetupController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('landlord.admin.setups.index', compact('setups'))->with('i', (request()->input('page', 1) - 1) * 10);
    }
    ...
    public function show(Setup $setup)
    {
        ...
        return view('landlord.admin.setups.show', compact('setup'));
    }
    ...
    public function edit(Setup $setup)
    {
        ...
        return view('landlord.admin.setups.edit', compact('setup'));
    }
