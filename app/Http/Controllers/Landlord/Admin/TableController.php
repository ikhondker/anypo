...
use App\Models\Landlord\Admin\Table;
...
class TableController extends Controller
{
    ...
    public function index()
    {
        ...
        // }
        //dd($tables);
        return view('landlord.admin.tables.index', compact('tables'))->with('i', 0);
    ...
    public function show(Table $table)
    {
        ...
        return view('landlord.admin.tables.show', with(compact('table', 'columns')));
    }
    ...
    public function structure($table)
    {
        ...
        //dd($tname);
        $columns = DB::SELECT('describe ' . $table);
        return view('landlord.admin.tables.structure', with(compact('columns', 'table')));
    }
    ...
    public function controllers()
    {
        ...
        return view('landlord.admin.tables.controllers', compact('filesInFolder'))->with('i', 0);
    ...
    public function models()
    {
        ...
        return view('landlord.admin.tables.models', compact('filesInFolder'))->with('i', 0);
    ...
    public function routes()
    {
        ...
        return view('landlord.admin.tables.all-routes', compact('routes'))->with('i', 0);
    }
    ...
    public function routeCode()
    {
        ...
        return view('landlord.admin.tables.routes', compact('filesInFolder'))->with('i', 0);
    ...
    public function policies()
    {
        ...
        return view('landlord.admin.tables.policies', compact('filesInFolder'))->with('i', 0);
    }
    ...
    public function comments()
    {
        ...
        return view('landlord.admin.tables.comments', compact('filesInFolder'))->with('i', 0);
    }
