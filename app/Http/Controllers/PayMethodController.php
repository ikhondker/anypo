...
class PayMethodController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pay-methods.index', compact('pay_methods'))->with('i', (request()->input('page', 1) - 1) * 10);
    }
    ...
    public function create()
    {
        ...
        return view('pay-methods.create', compact('currencies'));
    }
    ...
    public function edit(PayMethod $payMethod)
    {
        ...
        return view('pay-methods.edit', compact('payMethod'));
    }
