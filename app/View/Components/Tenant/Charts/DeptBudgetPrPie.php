...
class DeptBudgetPrPie extends Component
{
    ...
    {
        Log::debug('components.tenant.charts.DeptBudgetPrPie Value of dept_budget_id=' . $dept_budget_id);
		...
		Log::debug('components.tenant.charts.DeptBudgetPrPie Value of dept_id=' . $this->deptBudget->id);
