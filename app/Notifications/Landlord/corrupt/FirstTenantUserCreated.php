...
class FirstTenantUserCreated extends Notification  implements ShouldQueue
{
	...
	public function toMail(object $notifiable): MailMessage
	{
		...
		->line('Welcome to '.config('app.name').'. Your site is ready. Please review this email in its entirety as it contains important information. Your Application Admin account has been created as follows:')
