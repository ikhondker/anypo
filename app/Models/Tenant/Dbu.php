...
class Dbu extends Model
{
	...
	protected $fillable = [
		'dept_budget_id', 'entity', 'article_id', 'event', 'requestor_id', 'dept_id', 'unit_id', 'project_id', 'amount_pr_booked', 'amount_pr_issued', 'amount_po_booked', 'amount_po_issued', 'amount_grs','amount_invoice', 'amount_payment', 'updated_by', 'updated_at',
	];
