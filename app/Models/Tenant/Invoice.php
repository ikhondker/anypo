...
class Invoice extends Model
{
	...
	protected $fillable = [
		'invoice_no', 'invoice_date', 'po_id', 'supplier_id', 'summary', 'poc_id', 'currency', 'sub_total', 'tax', 'gst', 'amount', 'paid_amount', 'fc_exchange_rate', 'fc_sub_total', 'fc_tax', 'fc_gst', 'fc_amount', 'fc_paid_amount', 'dr_account', 'cr_account', 'notes', 'accounted', 'status', 'payment_status', 'error_code', 'updated_by', 'updated_at',
	];
