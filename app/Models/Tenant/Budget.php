...
class Budget extends Model
{
	...
	protected $fillable = [
		'fy', 'name', 'start_date', 'end_date', 'amount', 'amount_pr_booked', 'amount_pr_issued', 'amount_po_booked', 'amount_po_issued', 'amount_grs', 'amount_invoice', 'amount_payment', 'count_pr', 'count_po', 'count_grs', 'count_invoice', 'count_payment', 'notes', 'text_color', 'bg_color', 'icon', 'closed', 'updated_by', 'updated_at',
	];
