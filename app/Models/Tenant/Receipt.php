...
class Receipt extends Model
{
	...
	protected $fillable = [
		'receive_date', 'rcv_type', 'pol_id', 'warehouse_id', 'receiver_id', 'qty', 'price', 'amount', 'fc_exchange_rate', 'fc_amount', 'dr_account', 'cr_account', 'notes', 'accounted', 'status', 'updated_by', 'updated_at',
	];
