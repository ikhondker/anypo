...
class UploadItem extends Model
{
	...
	protected $fillable = [
		'owner_id', 'item_code', 'item_name', 'category_name', 'oem_name', 'uom_name', 'gl_type_name', 'price', 'status', 'notes', 'category_id', 'oem_id', 'uom_class_id', 'uom_id', 'gl_type', 'updated_by', 'updated_at',
	];
