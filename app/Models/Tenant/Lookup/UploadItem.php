...
class UploadItem extends Model
{
	...
	protected $fillable = [
		'owner_id', 'item_code', 'item_name', 'category_name', 'oem_name', 'uom_name', 'gl_type_name', 'ac_expense', 'price', 'status', 'notes', 'item_category_id', 'oem_id', 'uom_class_id', 'uom_id', 'gl_type', 'error_code', 'updated_by', 'updated_at',
	];
